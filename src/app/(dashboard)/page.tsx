    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-primary/10 bg-gradient-to-r from-primary/5 via-primary/10 to-transparent p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-muted-foreground max-w-2xl">
          You are logged in as <span className="font-semibold text-foreground">{session?.role === 'admin' ? 'Administrator' : 'Standard User'}</span>. Here is the current delivery status across the active stages in your Task Journey Tracker.
        </p>
      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="rounded-lg border border-border p-3 space-y-2">
              ...
              <div className="text-xs space-y-1 text-foreground">
                ...
                <p><span className="font-semibold text-muted-foreground">Role:</span> {session?.role}</p>
              </div>
            </div>
